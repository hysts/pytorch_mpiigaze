...
class Visualizer:
    ...
    def draw_model_axes(self, face: Face, lw: int = 2) -> None:
        assert self.image is not None
        ...
        # Scale the axes so that their lengths are equal to the difference
        # of the Y coordinates between the nose and the chin.
        axes3d = axes3d * MODEL3D.LANDMARKS[MODEL3D.CHIN_INDEX, 1]
